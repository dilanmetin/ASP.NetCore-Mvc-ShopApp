    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "iyi telefon", "0.jpg", true, false, "Samsung S5", 20000.0, "samsung-s5" },
                    { 2, "iyi telefon", "0.jpg", true, false, "Samsung S6", 24000.0, "samsung-s6" },
                    { 3, "iyi telefon", "0.jpg", true, false, "Samsung S7", 26000.0, "samsung-s7" },
                    { 4, "iyi telefon", "0.jpg", true, false, "Samsung S8", 26000.0, "samsung-s8" },
                    { 5, "iyi telefon", "0.jpg", true, false, "Samsung S9", 26000.0, "samsung-s9" }
                });
